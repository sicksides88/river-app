  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      if (response.success && checkoutUrl) {
        // Abrir Checkout Pro de MercadoPago: en la app de MP si está instalada,
        // si no en el navegador. La acreditación del saldo la confirma el webhook.
        ...
        // Volver a la billetera (recarga el saldo al enfocar / vía webhook).
        navigation.goBack();
      } else {
