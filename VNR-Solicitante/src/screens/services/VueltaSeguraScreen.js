...
const VueltaSeguraScreen = ({ navigation }) => {
  ...
  const calculateEstimate = async () => {
    ...
    try {
      ...
      // Precio desde las tarifas del CRM (lo que ves = lo que se cobra)
      setEstimatedPrice(await rideService.getEstimate('vuelta-segura', estimate.distance.km));
      ...
      setEstimatedPrice(await rideService.getEstimate('vuelta-segura', dist));
