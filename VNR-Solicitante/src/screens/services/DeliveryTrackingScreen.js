...
const DeliveryTrackingScreen = ({ navigation, route }) => {
      ...
      try {
        ...
        if (response.success && response.delivery) {
          ...
          const formattedDelivery = {
            ...
            // PIN de entrega: el backend solo lo devuelve al dueño del envío
            deliveryCode: fetchedDelivery.deliveryCode,
          };
  ...
  if (!delivery) {
    return (
      <View style={styles.loadingContainer}>
        <Ionicons name="alert-circle-outline" size={64} color={'rgba(255,255,255,0.55)'} />
  ...
  return (
    <View style={styles.container}>
      ...
      <ServiceTrackingCard
        ...
        deliveryCode={status !== 'delivered' && status !== 'cancelled' ? delivery?.deliveryCode : null}
