...
const NoEmbarcacionModal = ({ visible, onClose, onAddVessel }) => (
  <Modal
    visible={visible}
    animationType="slide"
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.content}>
          ...
          <Button title="Agregar embarcación" onPress={onAddVessel} style={styles.btn} />
        </View>
      </SafeAreaView>
    </View>
  </Modal>
...
const SinConexionModal = ({ visible, onClose }) => (
  <Modal
    visible={visible}
    animationType="slide"
    presentationStyle="fullScreen"
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.content}>
          ...
          <Button title="Reintentar" onPress={onClose} style={styles.btn} />
        </View>
      </SafeAreaView>
    </View>
  </Modal>
...
export { NoEmbarcacionModal, SinConexionModal };
export default NoEmbarcacionModal;
