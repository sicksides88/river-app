...
import {
  formatVesselSubtitle,
  getVesselDetailRows,
  getVesselFromAuxilio,
} from '../../utils/vesselDisplay';

const VesselInfoBlock = ({ auxilio, vessel: vesselProp, compact = false, style }) => {
  const vessel = vesselProp || getVesselFromAuxilio(auxilio);
