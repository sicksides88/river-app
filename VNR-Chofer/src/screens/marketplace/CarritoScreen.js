...
// CarritoScreen - Pantalla de carrito basado en Figma
const CarritoScreen = ({ navigation }) => {
  ...
  const handleCheckout = () => {
    ...
    navigation.navigate('Checkout', { items: cartItems, total: getTotal() });
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={styles.summarySection}>
          <Text style={styles.summaryTitle}>Resúmen de compra</Text>
