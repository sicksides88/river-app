        ...
        >
          ...
          <View style={styles.logoContainer}>
            <View style={styles.logoWrapper}>
              <Image
                source={require('../../../assets/logo-glow-bg.png')}
            ...
            <Text style={styles.logoTagline}>Asistencia & Servicios</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.optionsRow}>
              ...
              <TouchableOpacity onPress={() => Alert.alert('Próximamente', 'Esta función estará disponible pronto.')}>
