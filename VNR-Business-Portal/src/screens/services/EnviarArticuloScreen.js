...
// EnviarArticuloScreen - "Indicá el destino de tu envío" basado en Figma
const EnviarArticuloScreen = ({ navigation, route }) => {
  ...
  const handleAddressSelect = (item) => {
    ...
    setDestination({ address, coordinates: item.coordinates || null });
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        {/* Title */}
        <Text style={styles.title}>Indicá el destino de tu envío</Text>
...
export default EnviarArticuloScreen;
